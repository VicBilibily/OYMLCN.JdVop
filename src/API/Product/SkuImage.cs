...
namespace OYMLCN.JdVop
{
    public partial class JdVopApi
    {
        ...
        public static async Task<RspResult<Dictionary<string, ProductImage[]>>> ProductSkuImageAsync(string token, string sku)
        {
        ...
        /// <inheritdoc cref="ProductSkuImageAsync(string, string)"/>
        public async Task<RspResult<Dictionary<string, ProductImage[]>>> ProductSkuImageAsync(string sku)
            => await ProductSkuImageAsync(this.AccessToken, sku);
    }
}
